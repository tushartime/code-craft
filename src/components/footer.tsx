import { Blocks } from "lucide-react"; // will be used for the icon
import Link from "next/link";// will be used for the links

//span is a tag that is used to group inline elements

...
//   .id is accessing the dynamic segment of the URL path defined by [id] in the folder structure.
//  In this case, when someone visits /snippets/123, useParams().id will return "123".

  const snippet = useQuery(api.snippets.getSnippetById, { snippetId: snippetId as Id<"snippets"> });
  // jsi bhi sniipet ki id si same as snippetId we get by using param then return snippet 

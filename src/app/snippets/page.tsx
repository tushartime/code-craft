...
function SnippetsPage() {
  ...
  //HERE WE MADE -- LANGUAGE ARRAY IN WHICH WE GET SNIPPETS LANGUAGE 
  // THEN WE MADE POPULAR LANGUAGE ARRAY IN WHICH WE GET 5 LANGUAGE FROM LANGUAGE ARRAY
  // WHICH WE MAP LATER IN TO SHOW IN BUTTONS FORM line 106

  const languages = [...new Set(snippets.map((s) => s.language))];
  const popularLanguages = languages.slice(0, 5);
// .filter() method is a built-in JavaScript array method that creates a new array 
// with all elements that pass the test implemented by the provided function.
// so wo snippets array mai se wo wale filter krdega jo yh dono cases true return krega 
